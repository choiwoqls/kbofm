...
public class TeamVO {
	...
	private Date team_since;
	
	public TeamVO() {
		// TODO Auto-generated constructor stub
	}
		
	public TeamVO(int team_seq, String team_name, int team_unq_seq, String team_logo, String team_url, Date team_since) {
	...
	public Date getTeam_since() {
		return team_since;
	}

	public void setTeam_since(Date team_since) {
		this.team_since = team_since;
	}
